...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26/09/2024 às 18:19
...
INSERT INTO `agendamentos` (`agend_id`, `veic_usu_id`, `agend_data`, `agend_horario`, `agend_situacao`, `agend_observ`) VALUES
(1, 1, '2024-07-01', '09:00:00', 1, 'Primeiro agendamento para o veículo 1 do usuário 1'),
(2, 2, '2024-07-02', '10:00:00', 1, 'Primeiro agendamento para o veículo 2 do usuário 2'),
(3, 3, '2024-07-03', '11:00:00', 1, 'Primeiro agendamento para o veículo 3 do usuário 3'),
(4, 4, '2024-07-04', '08:00:00', 1, 'Primeiro agendamento para o veículo 4 do usuário 4'),
(5, 5, '2024-07-05', '09:30:00', 1, 'Primeiro agendamento para o veículo 5 do usuário 5'),
(6, 6, '2024-07-06', '10:30:00', 1, 'Primeiro agendamento para o veículo 6 do usuário 6'),
(7, 7, '2024-07-07', '11:30:00', 1, 'Primeiro agendamento para o veículo 7 do usuário 7'),
(8, 8, '2024-07-08', '12:00:00', 1, 'Primeiro agendamento para o veículo 8 do usuário 8'),
(9, 9, '2024-07-09', '13:00:00', 1, 'Primeiro agendamento para o veículo 1 do usuário 9'),
(10, 10, '2024-07-10', '14:00:00', 1, 'Primeiro agendamento para o veículo 2 do usuário 10'),
(11, 11, '2024-07-11', '15:00:00', 1, 'Primeiro agendamento para o veículo 3 do usuário 11'),
(12, 12, '2024-07-12', '16:00:00', 1, 'Primeiro agendamento para o veículo 4 do usuário 12'),
(13, 13, '2024-07-13', '17:00:00', 1, 'Primeiro agendamento para o veículo 5 do usuário 13'),
(14, 14, '2024-07-14', '09:15:00', 1, 'Primeiro agendamento para o veículo 6 do usuário 14'),
(15, 15, '2024-07-15', '10:15:00', 1, 'Primeiro agendamento para o veículo 7 do usuário 15'),
(16, 16, '2024-07-16', '11:15:00', 1, 'Primeiro agendamento para o veículo 8 do usuário 16'),
(17, 17, '2024-07-17', '12:15:00', 1, 'Primeiro agendamento para o veículo 1 do usuário 17'),
(18, 18, '2024-07-18', '13:15:00', 1, 'Primeiro agendamento para o veículo 2 do usuário 18'),
(19, 19, '2024-07-19', '14:15:00', 1, 'Primeiro agendamento para o veículo 3 do usuário 19'),
(20, 20, '2024-07-20', '15:15:00', 1, 'Primeiro agendamento para o veículo 4 do usuário 20'),
(21, 1, '2024-07-21', '16:15:00', 1, 'Segundo agendamento para o veículo 1 do usuário 1'),
(22, 2, '2024-07-22', '09:45:00', 1, 'Segundo agendamento para o veículo 2 do usuário 2'),
(23, 3, '2024-07-23', '10:45:00', 1, 'Segundo agendamento para o veículo 3 do usuário 3'),
(24, 4, '2024-07-24', '11:45:00', 1, 'Segundo agendamento para o veículo 4 do usuário 4'),
(25, 5, '2024-07-25', '12:45:00', 1, 'Segundo agendamento para o veículo 5 do usuário 5'),
(26, 6, '2024-07-26', '13:45:00', 1, 'Segundo agendamento para o veículo 6 do usuário 6'),
(27, 7, '2024-07-27', '14:45:00', 1, 'Segundo agendamento para o veículo 7 do usuário 7'),
(28, 8, '2024-07-28', '15:45:00', 1, 'Segundo agendamento para o veículo 8 do usuário 8'),
(29, 9, '2024-07-29', '16:45:00', 1, 'Segundo agendamento para o veículo 1 do usuário 9'),
(30, 10, '2024-07-30', '08:45:00', 1, 'Segundo agendamento para o veículo 2 do usuário 10');
...
INSERT INTO `categorias_servicos` (`cat_serv_id`, `cat_serv_nome`) VALUES
(1, 'Lavagem e Higienizacao'),
(2, 'Polimento e Protecao da Pintura'),
(3, 'Cuidados com Vidros e Farois'),
(4, 'Cuidados com Rodas e Pneus'),
(5, 'Detalhamento Interno (tailing)'),
(6, 'Remocao de Odores'),
(7, 'Correcao de Pintura'),
(8, 'Customizacao'),
(9, 'Reparos Esteticos'),
(10, 'Servicos Adicionais');
...
(1, 1, 'Lavagem externa (tradicional)', '00:30:00', 30.00, 'Lavagem externa convencional do veiculo.', b'1'),
(2, 1, 'Lavagem externa (a seco)', '00:40:00', 40.00, 'Lavagem externa do veiculo sem uso de agua.', b'1'),
...
CREATE TABLE `usuarios` (
  ...
  `usu_situacao` bit(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(1, 'José Oliveira', '321.654.987-00', '1995-10-20', 1, '(11) 5432-1098', 'jose@example.com', 'Observações sobre Jose Oliveira.', 1, 'jose789', b'1'),
(2, 'João da Silva', '111.222.333-44', '1988-03-10', 1, '(11) 2222-3333', 'joao@example.com', 'Observações sobre João da Silva.', 0, 'joao123', b'1'),
(3, 'Maria Oliveira', '555.666.777-88', '1992-08-25', 0, '(11) 4444-5555', 'maria@example.com', 'Observações sobre Maria Oliveira.', 0, 'maria456', b'1'),
(4, 'Pedro Santos', '999.888.777-66', '1980-12-05', 1, '(11) 7777-8888', 'pedro@example.com', 'Observações sobre Pedro Santos.', 0, 'pedro789', b'1'),
(5, 'Ana Souza', '777.888.999-11', '1990-06-15', 0, '(11) 9999-1111', 'ana@example.com', 'Observações sobre Ana Souza.', 0, 'ana123', b'1'),
(6, 'Fernando Lima', '444.555.666-22', '1985-09-30', 1, '(11) 8888-2222', 'fernando@example.com', 'Observações sobre Fernando Lima.', 0, 'fernando456', b'1'),
(7, 'Mariana Silva', '111.222.333-55', '1998-12-12', 0, '(11) 7777-5555', 'mariana@example.com', 'Observações sobre Mariana Silva.', 0, 'mariana789', b'1'),
(8, 'Carlos Oliveira', '222.333.444-66', '1987-04-25', 1, '(11) 5555-6666', 'carlos@example.com', 'Observações sobre Carlos Oliveira.', 0, 'carlos789', b'1'),
(9, 'Patrícia Ferreira', '888.777.666-99', '1991-08-10', 0, '(11) 2222-8888', 'patricia@example.com', 'Observações sobre Patrícia Ferreira.', 0, 'patricia123', b'1'),
(10, 'Lucas Santos', '777.666.555-11', '1993-11-15', 1, '(11) 9999-3333', 'lucas@example.com', 'Observações sobre Lucas Santos.', 0, 'lucas456', b'1'),
(11, 'Amanda Lima', '333.222.111-44', '1989-07-20', 0, '(11) 4444-7777', 'amanda@example.com', 'Observações sobre Amanda Lima.', 0, 'amanda789', b'1'),
(12, 'Rafael Almeida', '555.444.333-77', '1995-02-28', 1, '(11) 6666-9999', 'rafael@example.com', 'Observações sobre Rafael Almeida.', 0, 'rafael123', b'1'),
(13, 'Laura Souza', '999.888.777-22', '1986-06-05', 0, '(11) 7777-1111', 'laura@example.com', 'Observações sobre Laura Souza.', 0, 'laura456', b'1'),
(14, 'Guilherme Oliveira', '111.222.333-66', '1990-09-12', 1, '(11) 8888-4444', 'guilherme@example.com', 'Observações sobre Guilherme Oliveira.', 0, 'guilherme789', b'1'),
(15, 'Juliana Silva', '777.888.999-33', '1984-03-30', 0, '(11) 5555-2222', 'juliana@example.com', 'Observações sobre Juliana Silva.', 0, 'juliana123', b'1'),
(16, 'Rodrigo Santos', '444.555.666-88', '1983-11-05', 1, '(11) 6666-3333', 'rodrigo@example.com', 'Observações sobre Rodrigo Santos.', 0, 'rodrigo456', b'1'),
(17, 'Bianca Ferreira', '222.333.444-11', '1994-12-18', 0, '(11) 3333-8888', 'bianca@example.com', 'Observações sobre Bianca Ferreira.', 0, 'bianca789', b'1'),
(18, 'Fernanda Oliveira', '555.444.333-22', '1997-05-08', 0, '(11) 9999-2222', 'fernanda@example.com', 'Observações sobre Fernanda Oliveira.', 0, 'fernanda123', b'1'),
(19, 'Marcos Souza', '777.888.999-11', '1982-09-17', 1, '(11) 3333-4444', 'marcos@example.com', 'Observações sobre Marcos Souza.', 0, 'marcos456', b'1'),
(20, 'Carla Lima', '111.222.333-55', '1996-11-30', 0, '(11) 8888-9999', 'carla@example.com', 'Observações sobre Carla Lima.', 0, 'carla789', b'1'),
(23, 'wesley Silva', '444.555.111-00', '1998-10-15', 1, '(12) 2223-2222', 'wesley@example.com', 'Observações sobre Wesley.', 0, 'wesley1234', b'1'),
(24, 'José Oliveira Pop', '321.654.987-00', '1995-10-20', 1, '(11) 5432-1098', 'jose@example.com', 'Observações sobre Jose Oliveira.', 0, 'joliveira', b'1'),
(25, 'Admin', '000.000.000-00', '1995-10-20', 1, '(00) 0000-0000', 'admin@admin.com', 'admin', 1, 'admin', b'1'),
(26, 'User', '000.000.000-00', '1995-10-20', 1, '(00) 0000-0000', 'user@user.com', 'user', 0, 'user', b'1'),
(27, 'Matheus', '949.734.870-31', '2004-04-20', 1, '(14)99606-5761', 'matheus@gmail.com', '', 0, 'matheus', b'1'),
(28, 'Eduardo', '955.062.310-67', '2003-04-12', 1, '(18)99643-1203', 'eduardo@gmail.com', '', 0, 'eduardo', b'1'),
(29, 'Pedro', '020.263.110-99', '2000-02-19', 1, '(12)74989-9299', 'pedro@gmail.com', '', 0, 'pedro', b'1'),
(30, 'Arnaldo', '792.746.300-42', '1999-08-12', 1, '(23)99412-3441', 'arnaldo@gmail.com', '', 0, 'arnaldo', b'1'),
(31, 'Mac Miller', '319.541.400-70', '1993-11-17', 1, '(77)99604-2003', 'mac@gmail.com', '', 0, 'macmiller', b'1');
...
(1, 1, 'ABC1234', '2020', 'Prata', 'Diesel', 'Observacoes sobre o veiculo ABC1234 - caminhao', b'1'),
...
--
ALTER TABLE `agendamentos`
  MODIFY `agend_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `categorias_servicos`
  MODIFY `cat_serv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `servicos`
  MODIFY `serv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT de tabela `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `usu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT de tabela `veiculos`
--
ALTER TABLE `veiculos`
  MODIFY `veic_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `veiculo_usuario`
--
ALTER TABLE `veiculo_usuario`
  MODIFY `veic_usu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
