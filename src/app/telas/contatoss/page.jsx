                ...
                <div className={styles.container}>
                        ...
                        <div className={styles.card}>
                            <div className={styles.infoDuvidas}>
                                ...
                                <div className={styles.infos}>
                                    <span className={styles.informacao}>Telefone: (XX)XXXX-XXXX</span>
                                    <span className={styles.informacao}>WhatsApp: (XX)XXXX-XXXX</span>
                                    <span className={styles.informacao}>Email: urban_ouvidoria@teste.com</span>
                                </div>
                            </div>
                            <div className={styles.infoContatos}>
                                ...
                                <div className={styles.infos}>
                                    <span className={styles.informacao}>Telefone: (XX)XXXX-XXXX</span>
                                    <span className={styles.informacao}>WhatsApp: (XX)XXXX-XXXX</span>
                                    <span className={styles.informacao}>Email: urban_atendimento@teste.com</span>
                                </div>
                            </div>
                            <div className={styles.infoParcerias}>
                                ...
                                <div className={styles.infos}>
                                    ...
                                    <span className={styles.informacao}>Email: urban_rh@teste.com</span>
                                    <span className={styles.informacao}>Obrigado pelo contato!</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={styles.map}>
                        ...
                        <div className={styles.address}>
                            <Link href="https://maps.app.goo.gl/i3uxbgFqejEes5Vs5" target='_blank' className={styles.linkAddress}>R. Bezerra de Menezes, 215 - Vila Independencia <br /> Tupã - SP, 17605-440</Link>
                        </div>
                    </div>
                </div>
            </main >
